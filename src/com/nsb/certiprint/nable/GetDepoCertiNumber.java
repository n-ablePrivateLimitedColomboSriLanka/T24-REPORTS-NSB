 ...
 *
 */
public class GetDepoCertiNumber extends RecordLifecycle {
    ...
    public String formatDealSlip(String data, TStructure currentRecord, TransactionContext transactionContext) {
        ...
        try{
            ...
            AaPrdDesAccountRecord term = new AaPrdDesAccountRecord(cnt.getConditionForPropertyEffectiveDate("ACCOUNT", tdate));
            rtnValue = term.getLocalRefField("L.CERTIFICATE.N0").getValue();
        }catch(Exception e){
            rtnValue="";
        }
