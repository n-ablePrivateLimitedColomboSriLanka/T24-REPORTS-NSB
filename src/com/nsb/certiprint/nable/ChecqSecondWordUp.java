 ...
 *
 */
public class ChecqSecondWordUp extends RecordLifecycle {
                ...
                if(toReady.length()>44 && toReady.length()<88){
                    ...
                    if(toReady.substring(43,44).equals("")){
                     ...
                     if(toReady.substring(43,44).equals("")){
                         ...
                         Info("if-2-rtnValue2="+rtnValue); 
                     }else{
                         rtnValue= "-"+toReady.substring(44,88);
                         Info("else-2-rtnValue2="+rtnValue); 
                     }
