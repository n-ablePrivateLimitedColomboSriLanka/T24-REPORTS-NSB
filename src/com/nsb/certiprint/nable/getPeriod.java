 ...
 *
 */
public class getPeriod extends RecordLifecycle {
    ...
    public String formatDealSlip(String data, TStructure currentRecord, TransactionContext transactionContext) {
        ...
        try{
            ...
            AaPrdDesChangeProductRecord obj1= new AaPrdDesChangeProductRecord(cnt.getConditionForPropertyEffectiveDate("RENEWAL", tdate));
            
            rtnValue=obj1.getChangePeriod().toString();
