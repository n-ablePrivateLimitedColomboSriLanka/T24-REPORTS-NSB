 ...
 *
 */
public class EConLnPendingDisb extends Enquiry {
  ...
  public static void Info(String line) {
    ...
    public String setValue(String value, String currentId, TStructure currentRecord,
                ...
                try {
                    ...
                    if (Fxrate.size() > 0) {
                        ...
                        if (!loanIntrestValue.equals("")) {
                            ...
                            Info("loanIntrestValue=="+loanIntrestValue);
        ...
        appendDate = buildList(loanIntrestValueFinn, grantedAmountValue, limitId);

        return appendDate;

    }

    private String buildList(String loanIntrestValueFin, String approvedAmountValueFin, String limitIdValueFin) {
