 ...
 *
 */
public class NoFileDlyDisbsFinalUp extends Enquiry {
                  ...
                  try{
                      ...
                      for(EffectiveDateClass effCls : effDtList) {
                          String effectiveDate=effCls.getEffectiveDate().toString();
                              ...
                              if(effectiveDate.equals(disburseDate.toString()) || effectiveDate==disburseDate.toString()){
...
//                  ///////////////////////////////////////////////////////////////////////////////////////
                    ...
                    try {
                        ...
                        // removed AvailableAccountBalanceIntSub>0 condion and CurCommitBalanceIntSub>0 condition
                        if ((TotalCommitmentAmountIntSub!=AvailableAccountBalanceIntSub) && status==false && dateStatus==true) {

                            status2 = true;

                        } else if ((TotalCommitmentAmountIntSub!=CurCommitBalanceIntSub) && status==false && dateStatus==true) {
                        ...
                        if (status2 == true) {
                            ...
                            try{
                              ...
                              //previous disb value grantedAmountValue
                            appendDate = buildList(loanIntrestValueFinn, approvedAmountValue, disbAmountValueDou, grantedDateValue, tenureValue, ilstallment, prodGroup, prod, lonAccNo, arr, cus, currentDateAndTime);
    ...
    private String buildList(String loanIntrestValueFinnVal, String approvedAmountValue, String grantedAmountValue, String grantedDateValueFin, String tenureValueFin, String ilstallmentFin, String prodGroupValFin, String prodValFin, String lonAccNoValFin, String arrValFin, String cusFinVAl, String currentDateAndTimeFin) {
        try {
