 ...
 *
 */
public class NoFileLnPendDisbFinUp3 extends Enquiry {
...
//            if (FieldName.equals("DATE.INPUT"))
                ...
                try{
                    ...
                    try {
                        ...
                        if(status2==true){
                            ...
                            appendDate = buildList(loanIntrestValueFinn, approvedAmountValue, grantedAmountValue, grantedDateValue, tenureValue, ilstallment, arr, prodGroup, prod, lonAccNo,purpose);
    ...
    private String buildList(String loanIntrestValueFinnFin,String approvedAmountValueFin, String grantedAmountValueFin, String grantedDateValueFin, String tenureValueFin, String ilstallmentFin, String arrValFin, String prodGroupValFin, String prodValFin, String lonAccNoValFin, String purposeValFin) {
        try {
