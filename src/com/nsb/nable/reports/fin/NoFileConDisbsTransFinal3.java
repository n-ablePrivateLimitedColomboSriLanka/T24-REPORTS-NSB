 ...
 *
 */
public class NoFileConDisbsTransFinal3 extends Enquiry {
...
//            if (FieldName.equals("DATE.INPUT"))
            ...
            try{
                ...
                try{
                    ...
                    try {
                        ...
                        if ((totAmountVal !=AvailableAccountBalanceIntSub)&& AvailableAccountBalanceIntSub>0 && status==false) {

                            status2=true;
                        
                        }else if((totAmountVal !=CurCommitBalanceIntSub)&& CurCommitBalanceIntSub>0 && status==false){
                        ...
                        if(status2==true){
                            ...
                            appendDate = buildList(lonAccNo, grantedDateValue, grantedAmountValue, loanIntrestValueFinn, tenureValue, nextDueDate, purpose, totAmountValN, ilstallment, payAccFina, prodGroup);
    ...
    private String buildList(String loanNoFin,String grantedDateValueFin, String grantedAmountValueFin, String loanIntrestValueFinnFin, String tenureValueFin, String nextDueDateFin, String purposeFin, String totAmountValNFin, String ilstallmentFin, String payAccFina, String prodGroupFin) {
        try {
