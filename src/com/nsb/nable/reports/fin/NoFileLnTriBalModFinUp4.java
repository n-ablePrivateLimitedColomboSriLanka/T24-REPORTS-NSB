 ...
 *
 */
public class NoFileLnTriBalModFinUp4 extends Enquiry {
                ...
                try{
                    ...
                    try {
                        ...
                        if(status2==true){
                            ...
                            appendDate = buildList(loanIntrestValueFinn, grantedAmountValue, outStandingBalFinal, nextDueDate, grantedDateValue, totAmountValN, arr, prodGroup, prod, branchCode, arrStatus, lonAccNo);
