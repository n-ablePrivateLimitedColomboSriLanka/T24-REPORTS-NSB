 ...
 *
 */
public class NoFileLnTriBalSumModFinUp1 extends Enquiry {
...
//            if (FieldName.equals("DATE.INPUT"))
                ...
                try{
                    ...
                    try {
                        ...
                        if(status2==true){
                            ...
                            appendDate = buildList(outStandingBalFinal, grantedAmountValue, prodGroup, prod);
    ...
    private String buildList(String outStandingBalFinalFin, String grantedAmountValue, String prodGroupFinVal, String prodValFin) {
        try {
