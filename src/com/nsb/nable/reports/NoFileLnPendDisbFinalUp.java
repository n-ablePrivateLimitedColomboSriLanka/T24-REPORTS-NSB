 ...
 *
 */
public class NoFileLnPendDisbFinalUp extends Enquiry {
...
//                  ///////////////////////////////////////////////////////////////////////////////////////
                    ...
                    try {
                        ...
                        if (grantedAmountValueTemp > 0 && AvailableAccountBalanceIntSub>0 && status==false && dateStatus==true) {

                            status2=true;
                        
                        }else if(grantedAmountValueTempTwo > 0 && CurCommitBalanceIntSub>0 && status==false && dateStatus==true){
                        ...
                        if(status2==true){
                            ...
                            appendDate = buildList(loanIntrestValueFinn, approvedAmountValue, disbAmountValueDou, grantedDateValue, tenureValue, ilstallment, arr, prodGroup, prod, lonAccNo, purpose, currentDateAndTime, toBeDisbursedAmount);
    ...
    private String buildList(String loanIntrestValueFinnFin,String approvedAmountValueFin, String grantedAmountValueFin, String grantedDateValueFin, String tenureValueFin, String ilstallmentFin, String arrValFin, String prodGroupValFin, String prodValFin, String lonAccNoValFin, String purposeValFin, String currentDateAndTimeFin, String toBeDisbursedAmountFin) {
        try {
