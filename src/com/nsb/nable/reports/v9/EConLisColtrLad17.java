...
public class EConLisColtrLad17 extends Enquiry {
    ...
    public List<String> setValues(String value, String currentId, TStructure currentRecord, List<FilterCriteria> filterCriteria, EnquiryContext enquiryContext) {
        ...
        try{
            ...
            buildListfirst(nf.format(totalNominalValue),"","", nf.format(exceeded), grantedDateValue, grantedAmountValue, percent, flag);
        }catch(Exception e){
            log("calc");
            log(e.toString());
            buildListfirst("","","","","","","","");
    ...
    private void buildList(String totalNominalValue, String nominalValue, String collateralId, String exceededAmount, String grantedAmount, String grantedDate, String percent, String flag) {
        String result = "";
        try {
    ...
    private void buildListfirst(String totalNominalValue, String nominalValue, String collateralId, String exceededAmount, String grantedAmount, String grantedDate, String percent, String flag) {
        String result = "";
        try {
            StringBuilder str = new StringBuilder();
            str.append(totalNominalValue);
