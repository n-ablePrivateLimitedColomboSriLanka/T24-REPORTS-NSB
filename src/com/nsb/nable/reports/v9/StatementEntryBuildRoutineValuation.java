 ...
 *
 */
public class StatementEntryBuildRoutineValuation extends Enquiry {private DataAccess da = new DataAccess((T24Context)this);
    ...
    try {
        for (FilterCriteria criteria:filterCriteria){
            ...
            if(criteria.getFieldname().equals("ACCT.ID")){
                ...
                returnVal.setValue("LKR1513300010001");
