 ...
 *
 */
public class NoFileMortgageBond2 extends Enquiry {
    ...
    public List<String> setIds(List<FilterCriteria> filterCriteria, EnquiryContext enquiryContext) {
        ...
        for(String activityId:processActivityIds){
            ...
            try{
                ...
                authorizer = activityRecord.getAuthoriser().toString();
                inputter = activityRecord.getInputter(0);
            }catch(Exception e){
                log(e.toString());
                continue;
            }
            ...
            try{
                ...
                for (ChargeTypeClass chargeTypeClass : chargeType) {
                    ...
                    if(chargeName.equals("LOMORTINT") || chargeName.equals("LOMORTEXT") || chargeName.equals("LOMORTCHG")){
                            ...
                            if(!charge.equals("") && Double.valueOf(charge)>0.00){
                                /*if (chargeCount == 0){
                                    output.add(activityRecord.getTransactionRef().toString() + "*" +
                                            chargeName + "*" + charge  + "*" + date1 + "*" + chargeDebitAccount + "*" + authorizer + "*" + inputter); 
                                }
                                else{
    ...
    /* setFilterCriteria(filterCriteria);
        ...
        for(String losId:losIds){
                ...
                for (ChargeTypeClass chargeTypeClass : chargeType) {
                    ...
                    if(chargeName.equals("LOMORTEXT") || chargeName.equals("LOMORTINT")){
            ...
            try{
                if(!charge.equals("") && Integer.valueOf(charge)>0){
                    output.add(chargeName + "*" + losId+ "*" +charge);
                }
            }catch(Exception e){
                log(e.toString());
                if(!charge.equals("")){
    ...
    private void buildList(String losId,  String chargeName, String charge, String date, String debitAccount, 
            String authorizer, String Inputter) {
        String result = "";
        try {
