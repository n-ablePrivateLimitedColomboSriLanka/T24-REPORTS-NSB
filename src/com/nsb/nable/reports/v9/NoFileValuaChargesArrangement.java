 ...
 *
 */
public class NoFileValuaChargesArrangement extends Enquiry{
    ...
    public List<String> setIds(List<FilterCriteria> filterCriteria, EnquiryContext enquiryContext) {
        ...
        BillIds = this.da.selectRecords("", "AA.BILL.DETAILS","", "WITH BILL.TYPE EQ ACT.CHARGE AND PROPERTY EQ VALUATIONCHG");
        OUTER:
