 ...
 *
 */
public class NoFileCribCharges2 extends Enquiry {
        ...
        for(String activityId:processActivityIds){
            ...
            try{
                ...
                if (!(activity.equals("HL.LOS.AUTHORISE.CHARGE_V4")  || 
                        ...
                        activity.equals("PL.LOS.AUTHORISE.CHARGE_V2")) ||
            ...
            try{
                for (ChargeTypeClass chargeTypeClass : chargeType) {
                    ...
                    if(chargeName.equals("LOCRIBCHG") || chargeName.equals("CRIBCHG")){
