...
//                    JSONArray jsonArrayTwo = new JSONArray(paymentType);
//                    for(int i=0;i<jsonArrayTwo.length();i++){
//                        
//                        JSONObject explrObjectFour = jsonArrayTwo.getJSONObject(i);
//                        String billType = explrObjectFour.get("billType").toString();
//                        String precentages=explrObjectFour.get("Percentage").toString();
//                        
//                        if(billType.equals("DISBURSEMENT")){
//                            
//                            JSONArray jsonArrayThree = new JSONArray(precentages);
//                            noOfInstallmentDisbuserd= jsonArrayThree.length()+"";
//                          
//                        }
//                        
//                    }
