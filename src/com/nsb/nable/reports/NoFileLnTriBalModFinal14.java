 ...
 *
 */
public class NoFileLnTriBalModFinal14 extends Enquiry {
      ...
      //--------------------------------------------------------------------
        ...
        for (int j = 0; j < recarr.size(); j++) {
            ...
            try{
                ...
                String arrStatus=AaArr.getArrStatus().toString();
...
//                        if (outstandingBalIntSub>0 && status==false && dateStatus==true) {
                        ...
                        if(status2==true){
                            ...
                            appendDate = buildList(loanIntrestValueFinn, disbAmountValueDou, outStandingBalFinal, nextDueDate, grantedDateValue, totAmountValN, arr, prodGroup, prod, branchCode, arrStatus, lonAccNo, currentDateAndTime);
    ...
    private String buildList(String loanIntrestValueFinnFin,String grantedAmountValueFin, String outStandingBalFinalFin, String nextDueDateFin, String grantedDateValueFin, String totAmountValNFin, String arrIdFinVal, String prodGroupFinVal, String prodValFin, String branchCodeFinVal, String arrStatus, String lonAccNoFinVal, String currentDateAndTimeFin) {
        try {
            ...
            str.append("*" + arrIdFinVal);
            str.append("*" + prodGroupFinVal);
            str.append("*" + prodValFin);
            str.append("*" + branchCodeFinVal);
            str.append("*" + arrStatus);
            str.append("*" + lonAccNoFinVal);
